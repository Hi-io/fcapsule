...
Timing, episode membership and recurrence do not prove a shared cause. Current state may differ from incident-time state; missing samples are unknown, not healthy or zero. Keep alert intervals and image observation/upload times distinct. Later-only observations cannot establish an earlier failure's cause unless evidence shows the mechanism existed then.
